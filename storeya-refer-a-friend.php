...
function srff_settings()
{
    ...
    add_settings_section('storeya-refer-a-friend', "StoreYa Refer a Friend", "", 'storeya-refer-a-friend-group');
...
?>
        <h2><?php
            _e('StoreYa Refer a Friend Program', $srff_domain);
?> <small><?
...
?></small></h2>
        <div class="metabox-holder meta-box-sortables ui-sortable pointer">
          <div class="postbox" style="float:left;width:33em;margin-right:20px">
            ...
            _e('StoreYa Refer a Friend Program - Settings', $srff_domain);
?></span></h3>
...
$subtotal =((woocommerce_version_check())? $order_details->get_total():$order_details->get_order_total() ); 
